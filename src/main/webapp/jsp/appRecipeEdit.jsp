    ...
    <div class="dashboard-content border-dashed p-3 m-4 view-height">
        ...
        <form method="post">
            <div class="mt-4 ml-4 mr-4">
                ...
                <input name="created" type="hidden" class="w-100 p-1" value="${recipe.created}" required>
                <input name="recipeId" type="hidden" class="w-100 p-1" value="${recipe.id}" required>
                <table class="table borderless">
                    <tbody>
                    <tr class="d-flex">
                        <th scope="row" class="col-2">Nazwa Przepisu</th>
                        <td class="col-7">
                            <input name="name" class="w-100 p-1" value="${recipe.name}" required>
                        </td>
                    </tr>
                    <tr class="d-flex">
                        <th scope="row" class="col-2">Opis przepisu</th>
                        <td class="col-7"><textarea class="w-100 p-1" rows="5" name="description"
                                                    required>${recipe.description}</textarea></td>
                    </tr>
                    <tr class="d-flex">
                        <th scope="row" class="col-2">Przygotowanie (minuty)</th>
                        <td class="col-3">
                            <input class="p-1" type="number" value="${recipe.preparationTime}" name="preparationTime"
                                   required>
                        </td>
                    </tr>
                    </tbody>
                ...
                <div class="row d-flex">
                    <div class="col-5 p-4">
                        <textarea class="w-100 p-1" rows="10" name="preparation"
                                  required>${recipe.preparation}</textarea>
                    </div>
                    <div class="col-2"></div>

                    <div class="col-5 p-4">
                        <textarea class="w-100 p-1" rows="10" name="ingredients"
